...
export default function JobDetails({ job, onCloseDetail }: { job: API.Job; onCloseDetail: () => void }) {
  ...
  return (
    <div className="bg-white h-fit relative rounded-[4px] border border-gray-light shadow-md">
      <header className="flex items-center border-b border-gray-light p-5">
      ...
      <article className="p-5 max-h-[calc(100vh_-_260px)] overflow-y-auto" dangerouslySetInnerHTML={{ __html: job.jobDescription }}>
      </article>
    </div>
  );
}